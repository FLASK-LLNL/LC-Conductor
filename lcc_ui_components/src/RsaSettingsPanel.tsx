        ...
        <div className="mt-6 pl-8 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              />
              <p className="text-xs text-tertiary mt-1">Number of initial proposals to generate (≥ 2)</p>
            </div>
            ...
            <div>
              ...
              />
              <p className="text-xs text-tertiary mt-1">Subset size for aggregation (2 ≤ K ≤ N)</p>
            </div>
            ...
            <div>
              ...
              />
              <p className="text-xs text-tertiary mt-1">Total aggregation steps (≥ 2)</p>
            </div>
          </div>
